...
const Signup = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-96 bg-gradient-to-br from-[#667eea] to-[#764ba2] rounded-b-[60px] transform -translate-y-10 shadow-2xl">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 relative z-10 pt-10 pb-20">
        ...
        <div className="mb-10 w-full text-center">
           <h1 className="text-4xl font-black text-white mb-2 tracking-tight">Create<br/>Account</h1>
           <p className="text-white/80 font-medium">Join Adera to buy & sell secure accounts.</p>
        </div>
        ...
        <div className="bg-surface rounded-3xl p-6 shadow-2xl border border-white/5 w-full max-w-md mx-auto relative overflow-hidden">
           ...
           <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#e14fad] to-[#764ba2]"></div>
           ...
           <form onSubmit={handleSignup} className="flex flex-col gap-5">
             ...
             <div>
               ...
               <p className="text-xs text-gray-500 mt-2 ml-1 font-medium">Must be at least 6 characters.</p>
             </div>

              <p className="text-[11px] text-gray-500 text-center leading-relaxed">
                By signing up, you agree to our{' '}
                <Link to="/terms-of-service" className="text-[#b18cff] hover:text-white transition-colors underline">Terms of Service</Link>
                {' '}and{' '}
                <Link to="/privacy-policy" className="text-[#b18cff] hover:text-white transition-colors underline">Privacy Policy</Link>.
              </p>
           ...
           <div className="mt-8 flex items-center justify-center gap-2">
              ...
              <Link to="/login" className="text-[#b18cff] font-bold hover:text-white transition-colors">
                Log In
              </Link>
           </div>
