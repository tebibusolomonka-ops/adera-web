...
const Navbar = () => {
  ...
  return (
    <nav className="fixed bottom-0 w-full bg-surface border-t md:top-0 md:bottom-auto z-50" style={{ borderColor: 'var(--color-border)' }}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <div className="hidden md:flex flex-shrink-0 items-center">
            <h1 className="text-xl font-bold text-primary-400">Adera</h1>
          </div>
